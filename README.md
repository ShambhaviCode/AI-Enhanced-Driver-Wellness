...
**AI-Enhanced Driver Wellness Monitoring** leverages **Artificial Intelligence** to monitor, predict, and improve a driver’s physical, mental, and emotional state — creating a proactive approach to road safety.
...
| 🧘‍♀️ **Mental State** | Stress levels, focus, and alertness |
| 💬 **Emotional State** | Anxiety, frustration, or anger affecting behavior |
...
3. **Output Layer:**  
   ...
   - Dashboard recommendations (e.g., *“Take a short break”*).  
